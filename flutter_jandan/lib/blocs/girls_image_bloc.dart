...
class GirlsImageBLoC implements BLoCBase {

  StreamController<List<GirlsImageBean>> _girlsController = StreamController.broadcast();
  ...
  StreamController<bool> _indexController = StreamController();
  ...
  GirlsImageBLoC() {
    ...
    _girlsController.addError((error)=>print( "_girlsController error->${error.toString()}" ));
    _indexController.addError((error)=>print( "_indexController error->${error.toString()}" ));
  }
